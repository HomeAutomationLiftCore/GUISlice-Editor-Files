...
//<Enum !Start!>
enum {E_PG_MAIN};
enum {E_ELEM_LISTBOX2,E_ELEM_TEXT1,E_LISTSCROLL2};
...
//<InitGUI !Start!>
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,E_ELEM_TEXT1,E_PG_MAIN,(gslc_tsRect){43,10,234,26},
    (char*)"LIST BOX TEST",0,E_FONT_TXT15);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_WHITE);
   
  // Create wrapping box for listbox E_ELEM_LISTBOX2 and scrollbar
  pElemRef = gslc_ElemCreateBox(&m_gui,GSLC_ID_AUTO,E_PG_MAIN,(gslc_tsRect){60,50,200,100});
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_BROWN,GSLC_COL_BLACK,GSLC_COL_BLACK);
  
  // Create listbox
  pElemRef = gslc_ElemXListboxCreate(&m_gui,E_ELEM_LISTBOX2,E_PG_MAIN,&m_sListbox2,
    (gslc_tsRect){60+2,50+4,200-23,100-7},E_FONT_TXT15,
    (char*)&m_acListboxBuf2,sizeof(m_acListboxBuf2),0);
  ...
  gslc_ElemXListboxAddItem(&m_gui, pElemRef, "Test4");
  gslc_ElemXListboxAddItem(&m_gui, pElemRef, "Test5");
  gslc_ElemXListboxAddItem(&m_gui, pElemRef, "Test6");
  gslc_ElemSetFrameEn(&m_gui,pElemRef,true);
  Box1 = pElemRef;

  // Create vertical scrollbar for listbox
  pElemRef = gslc_ElemXSliderCreate(&m_gui,E_LISTSCROLL2,E_PG_MAIN,&m_sListScroll2,
          (gslc_tsRect){60+200-21,50+4,20,100-8},0,100,0,5,true);
